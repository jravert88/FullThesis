...
#ifndef _WINDOWS
    #include <unistd.h>
//    #include "../AppSource/AppDll.h"
#else
    #include "shrhelp.h"
    #include "../_AppSource/AppDll.h"
#endif
...
//	  printf("Device Serial Number = %d, 0x%x\n", serial_number, serial_number);
    ...
    HANDLE configFile = CreateFile("/home/adm85/git/JeffPaq/UltraSetup/src/ultra_config.dat", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
